#undef MATERALLEARN_API
#undef MATERALLEARN_VTABLE
...
#define UE_PROJECT_NAME MateralLearn
...
#define MATERALLEARN_VTABLE DLLEXPORT_VTABLE
#define MATERALLEARN_API DLLEXPORT
